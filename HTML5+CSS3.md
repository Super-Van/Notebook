...
我们看谷歌浏览器，当Toggle device toolbar按钮激活时，它显示的iPhone 6/7/8的屏宽是375，即开发像素，而不显示物理像素750。微信小程序iPhone 6/7/8屏宽是750，只是单位是rpx。

早期手机屏幕的物理像素比是1，但随着Retina（视网膜屏幕）技术的发展，物理像素比就增大了。retina把原来的一个像素点进一步拆分成更多的像素点，从而达到更高的分辨率，使得屏幕显示得更细腻。

那么在开发中，UI人员交付前端人员的设计稿往往是基于物理像素的，如iPhone 6的750，前端人员用google浏览器作参考视图的话就得先行减半尺寸。
