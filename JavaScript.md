...
在实际开发中，我们一般直接复制现有的常用的正则表达式。

我们应着重理解匹配一词的意思，即只要待检验字符串中存在满足指定规则的字符序列，就得到true的结果。
...
- Boostrap里的[Carousel](https://v3.bootcss.com/javascript/#carousel)。
