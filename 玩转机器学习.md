...
![image-20201222182148301](机器学习算法.assets/image-20201222182148301.png)
...
然而，随机梯度下降迭代次数仅为样本数的$\frac{1}{3}$是不科学的，我们需进一步将n_iters理解为基于全体样本的迭代次数即实质迭代次数为$n\_iters\times m$，每个样本至少被使用一次。
